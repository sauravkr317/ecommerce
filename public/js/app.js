...
var splideElm = document.querySelector('.splide');
...
var addToCart = document.querySelectorAll('.add-cart-btn');
var deleteCart = document.querySelectorAll('.cart-remover');
...
function updateCart(phone) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', phone).then(function (res) {
    var cart_item = document.querySelector('#cart-number');
    cart_item.innerText = res.data.totalQty;
  });
}

function removeCart(phone) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/delete-cart', phone).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    e.preventDefault();
    var phone = JSON.parse(btn.dataset.phone);
    updateCart(phone);
  });
});
...
if (deleteCart !== null) {
  deleteCart.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.preventDefault();
      var phone = JSON.parse(btn.dataset.phoneitem);
      removeCart(phone);
    });
  });
}
